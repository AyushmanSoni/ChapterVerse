...
const Navbar = () => {
  ...
  return (
    ...
    justify-between'> 
        ...
        <button className='px-4 py-2 text-[#086D8A] hover:text-[#075A71]'>
            SignIn</button>
        <button className='px-4 py-2v bg-[#086D8A] text-white border rounded-lg
         hover:bg-[#075A71]'>SignUp</button>
        </div>
    </div>
